...
public class ManagerLoginController {
    ...
    public void handleLogin(ActionEvent event) throws Exception {
        ...
        if (email.isEmpty() || password.isEmpty()) {
            ...
            return;
        } else if (!dbController.typechecker(email).equals("product manager")) {
            showError("This is not product manager account");
        } else if (dbController.loginchecker(email, password) == true && dbController.typechecker(email).equals("product manager")) {

            // Save session
            UserSession.set(dbController.getUserName(email), email, "Product Manager");
